...
class Body extends StatelessWidget {
  ...
  late final listSubTotalLabourCostOnSite;
            ...
            child: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<Rekapitulasi> snapshot) {
                if (snapshot.hasData) {
                  ...
                  listSubTotalLabourCostOnSite = List.generate(lengRekapitulasi, (_) => []);
                  ...
                  for(int i = 0 ; i < lengRekapitulasi ; i++){
                    if (rekapitulasi.data[i].analisaLabourCostOnsite!.isNotEmpty) {
                      for (var j = 0; j < rekapitulasi.data[i].analisaLabourCostOnsite!.length; j++) {
                        num subTotal = double.parse(rekapitulasi.data[i].analisaLabourCostOnsite![j].qty.toString()) * double.parse(rekapitulasi.data[i].analisaLabourCostOnsite![j].unitPrice.toString()) * double.parse(rekapitulasi.data[i].analisaLabourCostOnsite![j].konstanta.toString());
                        subTotalLabourCostOnSite.add(subTotal);
                        totalLabourCostOnSite = totalLabourCostOnSite + subTotal.round();
                      }
                      listSubTotalLabourCostOnSite[i].addAll(subTotalLabourCostOnSite);
                        ...
                        children: <Widget> [
                          ListView.builder(
                            ...
                            itemBuilder: (context, i){
                              return Column(
                                children: [
                                  for(int index = 0 ; index < rekapitulasi.data[i].analisaLabourCostOnsite!.length ; index++)...[
                                    Padding(
                                      padding: EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(10)),
                                      child: CardItemExpansionDetail(
                                        child: ListTile(
                                          ...
                                          title: HighlightItemName(
                                            child: Text(
                                              rekapitulasi.data[i].analisaLabourCostOnsite![index].kodeItem.toString(),
                                              style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14,),
                                              overflow: TextOverflow.ellipsis,
                                            ),
                                          ),
                                                    ...
                                                    Expanded(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          Padding(
                                                            padding: const EdgeInsets.only(left: 0),
                                                            child: Text(rekapitulasi.data[i].analisaLabourCostOnsite![index].namaItem.toString(),
                                                              style: const TextStyle(
                                                                color: Colors.black,
                                                              ),
                                                              textAlign: TextAlign.left,
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              formatDecimal.format(
                                                                double.parse(rekapitulasi.data[i].analisaLabourCostOnsite![index].qty.toString()
                                                                )
                                                              )+" "+
                                                              rekapitulasi.data[i].analisaLabourCostOnsite![index].namaSatuan.toString(),
                                                              style: const TextStyle(
                                                                color: Colors.black,
                                                              ),
                                                              textAlign: TextAlign.left,
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              formatCurrency.format(
                                                                double.parse(rekapitulasi.data[i].analisaLabourCostOnsite![index].unitPrice.toString())
                                                              ),
                                                              style: const TextStyle(
                                                                color: Colors.black,
                                                              ),
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              formatDecimal.format(
                                                                double.parse(rekapitulasi.data[i].analisaLabourCostOnsite![index].konstanta.toString()
                                                                )
                                                              ),
                                                              style: const TextStyle(
                                                                color: Colors.black,
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              formatCurrency.format(
                                                                double.parse(listSubTotalLabourCostOnSite[i][index].toString())
                                                              ),
                                                              style: const TextStyle(
                                                                color: Colors.black,
                                                              ),
