...
class _BodyHistoryState extends State<BodyHistory> {
  ...
  Future<List<Datum>> fetchHistoryDeliveryOrder({required int page}) async {
    ...
    var requestUrl = MGPAPI.baseURL + '/approval_delivery_order/history/?' + queryString;
    final response =
  ...
  Future _refreshPage() async{
    ...
    _future = fetchHistoryDeliveryOrder(page: pages);
  }
                            ...
                            children: <Widget>[
                              RefreshIndicator(
                                ...
                                child: ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount: dataDeliveryOrder.length,
                                        ...
                                        subtitle: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              CardFieldItemText(
                                                label: "Diajukan oleh",
                                                contentData: dataDeliveryOrder[index].namaKaryawanPengaju,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
