...
class _BodyState extends State<Body> with SPKClass{
  ...
  Future _refreshPage() async{
    ...
    _future = fetchApprovalSPK(page: pages);
  }
                                  ...
                                  itemBuilder: (context, index){
                                    return CardList(
                                      child: ListTile(
                                        ...
                                        subtitle: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              CardFieldItemText(
                                                label: "Diajukan oleh",
                                                contentData: dataSPK[index].namaKaryawanPengaju,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              ...
                                              CardFieldItemText(
                                                label: "Jabatan",
                                                contentData: dataSPK[index].namaJabatanPengaju,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              SizedBox(height: getProportionateScreenHeight(10).h),
                                              ...
                                              CardFieldItemText(
                                                label: "Customer",
                                                contentData: dataSPK[index].namaCustomer,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              SizedBox(height: getProportionateScreenHeight(10).h),
                                              CardFieldItemText(
                                                label: "Proyek",
                                                contentData: dataSPK[index].namaProyek,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              SizedBox(height: getProportionateScreenHeight(10).h),
                                              CardFieldItemStatus(
                                                contentData: dataSPK[index].statusApproval,
                                              ),
                                            ],
                                          ),
                                        ), 
                                        onTap: () {
                                          Get.to(
                                            DetailSuratPerjanjianKerjaView(
                                              noSpk: dataSPK[index].noSpk.toString(),
                                              baseline: dataSPK[index].baseline.toString(),
                                              statusMenu: "Approval",
                                            )
                                          );
                                        },
                        ...
                        return Padding(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Skeleton(
                                width: double.infinity,
                                height: getProportionateScreenHeight(250).h,
                              ),
                              SizedBox(height: getProportionateScreenHeight(5).h),
                            ],
                          ),
