      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: FutureBuilder<DetailRegrae>(
                  ...
                  if (dataPrelim!.data!.detail!.prelim!.isNotEmpty) {
                    for (var j = 0; j < dataPrelim.data!.detail!.prelim!.length; j++) {
                      ...
                      * double.parse(dataPrelim.data!.detail!.prelim![j].konstanta.toString());
                      if (dataPrelim.data!.detail!.prelim![j].namaKelompok.toString() == "ATK") {
                        atk.add(
                          ListDataPrelim(
                      ...
                      } else if (dataPrelim.data!.detail!.prelim![j].namaKelompok.toString() == "Safety") {
                        safety.add(
                          ListDataPrelim(
                            dataPrelim.data!.detail!.prelim![j].kodeItemPrelim.toString(),
                            dataPrelim.data!.detail!.prelim![j].namaItemPrelim.toString(),
                      ...
                      } else if (dataPrelim.data!.detail!.prelim![j].namaKelompok.toString() == "Proteksi") {
                        proteksi.add(
                          ListDataPrelim(
                            dataPrelim.data!.detail!.prelim![j].kodeItemPrelim.toString(),
                            dataPrelim.data!.detail!.prelim![j].namaItemPrelim.toString(),
                      ...
                      } else if (dataPrelim.data!.detail!.prelim![j].namaKelompok.toString() == "Hand Tools") {
                        handTools.add(
                          ListDataPrelim(
                            dataPrelim.data!.detail!.prelim![j].kodeItemPrelim.toString(),
                            dataPrelim.data!.detail!.prelim![j].namaItemPrelim.toString(),
                      ...
                      } else if (dataPrelim.data!.detail!.prelim![j].namaKelompok.toString() == "Honor Staff") {
                        honorStaff.add(
                          ListDataPrelim(
                            dataPrelim.data!.detail!.prelim![j].kodeItemPrelim.toString(),
                            dataPrelim.data!.detail!.prelim![j].namaItemPrelim.toString(),
                      ...
                      } else if (dataPrelim.data!.detail!.prelim![j].namaKelompok.toString() == "Lain-lain") {
                        lainLain.add(
                          ListDataPrelim(
                            dataPrelim.data!.detail!.prelim![j].kodeItemPrelim.toString(),
                            dataPrelim.data!.detail!.prelim![j].namaItemPrelim.toString(),
