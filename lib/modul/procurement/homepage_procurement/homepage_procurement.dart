...
class HomePageProcurement extends StatefulWidget {
  const HomePageProcurement({Key? key}) : super(key: key);

  @override
  _HomePageProcurementState createState() => _HomePageProcurementState();
}

class _HomePageProcurementState extends State<HomePageProcurement> {
  int selectedIndex = 0;
