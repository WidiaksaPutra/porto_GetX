...
class HomePageAnggaran extends StatefulWidget {
  const HomePageAnggaran({Key? key}) : super(key: key);

  @override
  _HomePageAnggaranState createState() => _HomePageAnggaranState();
}

class _HomePageAnggaranState extends State<HomePageAnggaran> {
  int selectedIndex = 0;
