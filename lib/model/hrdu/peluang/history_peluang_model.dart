...
class HistoryRegplg {
  ...
  factory HistoryRegplg.fromRawJson(String str) => HistoryRegplg.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory HistoryRegplg.fromJson(Map<String, dynamic> json) => HistoryRegplg(
    status: json["status"],
