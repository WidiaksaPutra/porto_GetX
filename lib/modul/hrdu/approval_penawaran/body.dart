...
class _BodyState extends State<Body> with PenawaranClass {
  ...
  Future _refreshPage() async{
    ...
    _future = fetchApprovalPenawaran(page: pages);
  }
                                        ...
                                        subtitle: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              CardFieldItemText(
                                                label: "Diajukan oleh",
                                                contentData: dataPenawaran[index].namaKaryawan,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              ...
                                              CardFieldItemText(
                                                label: "Jabatan",
                                                contentData: dataPenawaran[index].namaJabatan,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              SizedBox(height: getProportionateScreenHeight(10).h),
                                              ...
                                              CardFieldItemText(
                                                label: "Proyek",
                                                contentData: dataPenawaran[index].namaProyek,
                                                flexLeftRow: 12,
                                                flexRightRow: 20,
                                              ),
                                              SizedBox(height: getProportionateScreenHeight(10).h),
