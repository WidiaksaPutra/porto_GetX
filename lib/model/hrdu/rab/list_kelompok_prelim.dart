...
class ListKelompokPrelimRegrab {
  ListKelompokPrelimRegrab({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory ListKelompokPrelimRegrab.fromRawJson(String str) => ListKelompokPrelimRegrab.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ListKelompokPrelimRegrab.fromJson(Map<String, dynamic> json) => ListKelompokPrelimRegrab(
    status: json["status"],
