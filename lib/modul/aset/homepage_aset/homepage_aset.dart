...
class HomePageAset extends StatefulWidget {
  const HomePageAset({Key? key}) : super(key: key);

  @override
  _HomePageAsetState createState() => _HomePageAsetState();
}

class _HomePageAsetState extends State<HomePageAset> {
  int selectedIndex = 0;
