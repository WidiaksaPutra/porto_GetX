...
class HomePagePenjualan extends StatefulWidget {
  const HomePagePenjualan({Key? key}) : super(key: key);

  @override
  _HomePagePenjualanState createState() => _HomePagePenjualanState();
}

class _HomePagePenjualanState extends State<HomePagePenjualan> {
  int selectedIndex = 0;
