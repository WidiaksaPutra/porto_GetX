...
//   final Future<AnalisaSingleRegplgUmum> futureAnalisaSinglePeluangUmum;
...
//   const BodyInformasi({Key? key, required this.futureAnalisaSinglePeluangUmum, required this.futureAnalisaSinglePeluangBaku, required this.fetchAnalisaSinglePeluangPenunjang, required this.fetchAnalisaSinglePeluangFinishing}) : super(key: key);
...
//               builder: (BuildContext context, AsyncSnapshot<AnalisaSingleRegplgUmum> snapshot) {
//                 if (snapshot.hasData) {
...
//                   // num volumePlywood = 0;
//                   // if (analisaSinglePeluang!.data!.analisaHardwood!.isNotEmpty) {
//                   //   for (var i = 0; i < analisaSinglePeluang.data!.analisaHardwood!.length; i++) {
//                   //     num volume = (double.parse(analisaSinglePeluang.data!.analisaHardwood![i]!.tRaw.toString()) * double.parse(analisaSinglePeluang.data!.analisaHardwood![i]!.wRaw.toString()) * double.parse(analisaSinglePeluang.data!.analisaHardwood![i]!.lRaw.toString()) * double.parse(analisaSinglePeluang.data!.analisaHardwood![i]!.qtyRaw.toString()))/1000000;
//                   //     volumeHardwood = volumeHardwood + volume;
//                   //     listVolumeHardwood.add(volume);
//                   //     num subTotal = volume * double.parse(analisaSinglePeluang.data!.analisaHardwood![i]!.unitPrice.toString()) * double.parse(analisaSinglePeluang.data!.analisaHardwood![i]!.konstanta.toString());
//                   //     subTotalHardwood.add(subTotal);
//                   //     totalHardwood = totalHardwood + subTotal;
//                   //     if (analisaSinglePeluang.data!.analisaHardwood![i]!.namaTipeSisi.toString() == "4 Sisi (2TL + 2WL)") {
...
//                                 contentData: analisaSinglePeluang!.data!.kodeItem,
//                                 flexLeftRow: 14,
//                                 flexRightRow: 20,
//                               ),
...
//                                 contentData: analisaSinglePeluang.data!.namaItem,
//                                 flexLeftRow: 14,
//                                 flexRightRow: 20,
//                               ),
//                               SizedBox(height: getProportionateScreenHeight(5).h),
...
//                                 contentData: analisaSinglePeluang.data!.namaKelompok,
//                                 flexLeftRow: 14,
//                                 flexRightRow: 20,
//                               ),
//                               SizedBox(height: getProportionateScreenHeight(5).h),
//                               CardFieldItemText(
//                                 label: "Satuan Jual",
//                                 contentData: analisaSinglePeluang.data!.namaSatuan,
//                                 flexLeftRow: 14,
//                                 flexRightRow: 20,
//                               ),
//                               SizedBox(height: getProportionateScreenHeight(5).h),
...
//                                 linkReferensi: analisaSinglePeluang.data!.linkReferensi,
//                                 flexLeftRow: 14,
//                                 flexRightRow: 20,
//                               ),
//                             ],
...
//                                   child: (analisaSinglePeluang.data!.uraian != null)
//                                   ? Html(
//                                     data: analisaSinglePeluang.data!.uraian
//                                   )
//                                   :  Text("-",
//                                     style: TextStyle(
//                                       color: Colors.black,
