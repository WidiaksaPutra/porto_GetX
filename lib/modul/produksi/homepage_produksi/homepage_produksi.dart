...
class HomePageProduksi extends StatefulWidget {
  const HomePageProduksi({Key? key}) : super(key: key);

  @override
  _HomePageProduksiState createState() => _HomePageProduksiState();
}

class _HomePageProduksiState extends State<HomePageProduksi> {
  int selectedIndex = 0;
