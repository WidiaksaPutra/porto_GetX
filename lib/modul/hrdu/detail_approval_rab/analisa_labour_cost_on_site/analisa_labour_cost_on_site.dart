...
import 'package:mgp_mobile_app/modul/hrdu/detail_approval_rab/analisa_labour_cost_on_site/body.dart';
import 'package:mgp_mobile_app/widget/theme/appbar_theme_color.dart';

class AnalisaLabourCostOnSiteView extends StatelessWidget {
  const AnalisaLabourCostOnSiteView({Key? key, required this.analisaSingleRegrab}) : super(key: key);
