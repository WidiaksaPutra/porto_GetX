...
class HomePageCOC extends StatefulWidget {
  const HomePageCOC({Key? key}) : super(key: key);

  @override
  _HomePageCOCState createState() => _HomePageCOCState();
}

class _HomePageCOCState extends State<HomePageCOC> {
  int selectedIndex = 0;
