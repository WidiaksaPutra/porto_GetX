...
class ListKelompokPrelimRegsospk {
  ListKelompokPrelimRegsospk({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory ListKelompokPrelimRegsospk.fromRawJson(String str) => ListKelompokPrelimRegsospk.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ListKelompokPrelimRegsospk.fromJson(Map<String, dynamic> json) => ListKelompokPrelimRegsospk(
    status: json["status"],
