...
class TipeFinisihingRegrae {
  TipeFinisihingRegrae({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory TipeFinisihingRegrae.fromRawJson(String str) => TipeFinisihingRegrae.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TipeFinisihingRegrae.fromJson(Map<String, dynamic> json) => TipeFinisihingRegrae(
    status: json["status"],
