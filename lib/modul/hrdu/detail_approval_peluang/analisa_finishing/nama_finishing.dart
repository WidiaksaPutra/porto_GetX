...
class NamaBody extends StatefulWidget {
  ...
  const NamaBody({Key? key, required this.analisaSingleRegplgFinishing}) : super(key: key);
                      ...
                      for(int j = 0 ; j < listNamaFinishingBarangJadi.length ; j++)...[
                        if(listNamaFinishingBarangJadi[j].toString() != "-")...[
                          CardFieldAnalisa(
                            ...
                            onTap: () {
                              Get.to(AnalisaFinishingView2(namaFinishing: listNamaFinishingBarangJadi[j].toString(), analisaSingleRegplgFinishing: widget.analisaSingleRegplgFinishing));
                            },
                          ),
                        ],
                      ]
