...
import 'package:mgp_mobile_app/modul/hrdu/detail_approval_rap/analisa_finishing/analisa_finishing.dart';
import 'package:mgp_mobile_app/modul/hrdu/detail_approval_rap/analisa_penunjang_produksi/analisa_penunjang_produksi.dart';
...
class BodyInformasi extends StatefulWidget {
  ...
  const BodyInformasi({Key? key, required this.futureAnalisaSingleRap}) : super(key: key);
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      CardFieldAnalisa(
                        ...
                        onTap: () {
                          Get.to(AnalisaBahanBakuView(analisaSingleRegrap: widget.futureAnalisaSingleRap));
                        },
                      ),
                      CardFieldAnalisa(
                        label: "Analisa Penunjang Produksi",
                        onTap: () {
                          Get.to(AnalisaPenunjangProduksiView(analisaSingleRegrap: widget.futureAnalisaSingleRap));
                        },
                      ),
                      CardFieldAnalisa(
                        label: "Analisa Finishing",
                        onTap: () {
                          Get.to(AnalisaFinishingView(analisaSingleRegrap: widget.futureAnalisaSingleRap));
                        },
                      ),
