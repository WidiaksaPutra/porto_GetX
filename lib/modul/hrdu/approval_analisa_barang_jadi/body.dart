...
class _BodyState extends State<Body> {
  ...
  Future<List<Datum>> fetchApprovalAnalisaBarangJadi({required int page}) async {
  ...
  Future _refreshPage() async{
    ...
    _future = fetchApprovalAnalisaBarangJadi(page: pages);
  }
                                  ...
                                  itemBuilder: (context, index){
                                    return CardList(
                                      child: ListTile(
                                        ...
                                        onTap: () {
                                          Get.to(DetailAnalisaBarangJadiView(idItemBuaso: dataAnalisaBarangJadi[index].idItemBuaso.toString(), statusMenu: "Approval"));
                                        },
                                      ),
                                    );
                                  }
