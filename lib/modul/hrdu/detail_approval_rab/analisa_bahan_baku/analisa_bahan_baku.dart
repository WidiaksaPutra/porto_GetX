...
import 'package:mgp_mobile_app/modul/hrdu/detail_approval_rab/analisa_bahan_baku/body.dart';

class AnalisaBahanBakuView extends StatelessWidget {
  const AnalisaBahanBakuView({Key? key, required this.analisaSingleRegrab}) : super(key: key);
