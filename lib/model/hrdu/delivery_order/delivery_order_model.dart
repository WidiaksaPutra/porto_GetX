...
class Regdo {
  ...
  factory Regdo.fromRawJson(String str) => Regdo.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory Regdo.fromJson(Map<String, dynamic> json) => Regdo(
    status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    tglSuratJalan: json["tgl_surat_jalan"],
