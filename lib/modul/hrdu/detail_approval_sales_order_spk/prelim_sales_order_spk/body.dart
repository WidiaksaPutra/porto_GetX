...
class _BodyState extends State<Body> {
  ...
  late Future<ListKelompokPrelimRegsospk> futurePrelim;

  @override
  void initState() {
    futurePrelim = MGPAPI().fetchAnalisaPrelimSOSPK();
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: FutureBuilder<ListKelompokPrelimRegsospk>(
              future: futurePrelim,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  var listKelompokPrelim = snapshot.data;
                  return FutureBuilder<DetailRegsospk>(
