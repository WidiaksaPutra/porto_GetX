...
class HomePageProyek extends StatefulWidget {
  const HomePageProyek({Key? key}) : super(key: key);

  @override
  _HomePageProyekState createState() => _HomePageProyekState();
}

class _HomePageProyekState extends State<HomePageProyek> {
  int selectedIndex = 0;
