...
class HomePageMarketing extends StatefulWidget {
  const HomePageMarketing({Key? key}) : super(key: key);

  @override
  _HomePageMarketingState createState() => _HomePageMarketingState();
}

class _HomePageMarketingState extends State<HomePageMarketing> {
  int selectedIndex = 0;
